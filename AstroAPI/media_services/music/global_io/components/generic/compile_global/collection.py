...
from AstroAPI.media_services.music.global_io.components.generic.about import service as gservice, component as gcomponent
...
def compiled_collection(request: dict, unlabeled_collections: list) -> Collection:
	...
	release_date_order = [apple_music.service, spotify.service, deezer.service, youtube_music.service]
