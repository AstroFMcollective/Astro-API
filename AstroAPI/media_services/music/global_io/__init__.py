...
class GlobalIO:
	...
	async def lookup_song(self, service: object, id: str, song_country_code: str = None, lookup_country_code: str = 'us') -> Song | Empty | Error:
		return await lookup_song(service = service, id = id, song_country_code = song_country_code, lookup_country_code = lookup_country_code)
	...
	async def lookup_music_video(self, service: object, id: str, mv_country_code: str = None, lookup_country_code: str = 'us') -> MusicVideo | Empty | Error:
		return await lookup_music_video(service = service, id = id, mv_country_code = mv_country_code, lookup_country_code = lookup_country_code)
	...
	async def lookup_collection(self, service: object, id: str, collection_country_code: str = None, lookup_country_code: str= 'us') -> Collection | Song | Empty | Error:
		return await lookup_collection(service = service, id = id, collection_country_code = collection_country_code, lookup_country_code = lookup_country_code)
