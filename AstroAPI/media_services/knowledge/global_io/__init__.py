...
from AstroAPI.media_services.knowledge.global_io.components.search.query import search_query as search_query_knowledge
from AstroAPI.media_services.knowledge.global_io.components.lookup.song import lookup_song as lookup_song_knowledge
