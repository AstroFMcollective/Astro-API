...
from AstroAPI.media_services.music.spotify.components.search.song import search_song
from AstroAPI.media_services.knowledge.spotify.components.lookup.song_knowledge import lookup_song_knowledge
import aiohttp
...
async def search_song_knowledge(artists: list, title: str, song_type: str = None, collection: str = None, is_explicit: bool = None, country_code: str = 'us') -> object:
	...
	song = await search_song(artists, title, song_type, collection, is_explicit, country_code)
