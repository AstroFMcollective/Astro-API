...
from AstroAPI.ServiceCatalogAPI.media_services.knowledge.global_io.components.search.query import search_query as search_query_knowledge
from AstroAPI.ServiceCatalogAPI.media_services.knowledge.global_io.components.lookup.song import lookup_song as lookup_song_knowledge
...
class GlobalIO:
	...
	async def search_song(self, artists: list, title: str, song_type: str = None, collection: str = None, is_explicit: bool = None, country_code: str = 'us', include_premade_media: list = [], exclude_services: list = []) -> SongKnowledge | Empty | Error:
		"""
	...
	async def search_query(self, query: str, country_code: str = 'us', exclude_services: list = []) -> SongKnowledge | Empty | Error:
		"""
	...
	async def lookup_song(self, service: object, id: str, song_country_code: str = None, lookup_country_code: str = 'us') -> SongKnowledge | Empty | Error:
		"""
