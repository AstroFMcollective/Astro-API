...
from ServiceCatalogAPI.media_services.music.apple_music.components.lookup.artist import lookup_artist
from ServiceCatalogAPI.media_services.music.apple_music.components.lookup.collection import lookup_collection
